...
"""
Save the accuracy metrics of the matcher results (query no entity type provided), for a independent created evaluation
data independent_eval_data.json
run by:
- uv run -m evaluation.independent_data_eval
...
EXTERNAL_METRICS_FILE: Path = BASE_DIR / "independent_evaluation_metrics.json"
EXTERNAL_RESULTS_FILE: Path = BASE_DIR / "independent_evaluation_results.json"
...
def print_metrics(metrics: Metrics) -> None:
    ...
    print("Independent Data Evaluation")
    print("-------------------")
